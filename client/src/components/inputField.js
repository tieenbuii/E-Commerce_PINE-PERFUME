...
const InputField = ({ value, setValue, nameKey, type, invalidFields, setInvalidFields }) => {
  return (
    <div className='w-full flex flex-col relative mb-2'>
      {value.trim() !== '' && 
        <label className='text-[10px] animate-slide-top-sm absolute top-0 left-[-12px] block bg-white px-1' htmlFor={nameKey}>
...
// Example of invalidFields: [{ name: 'password', mes: 'Required' }]
